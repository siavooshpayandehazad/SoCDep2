...
import Arch_Graph_Reports
from AG_Functions import ReturnNodeNumber, ReturnNodeLocation,GenerateAG
from RoutingAlgorithms import Routing, Calculate_Reachability, RoutingGraph_Reports
from SystemHealthMonitoring import SystemHealthMonitor, SHM_Reports
import random, copy
...
def OptimizeAG_VL_LocalSearch(AG, SHM, logging):
    ...
    print ("INITIAL REACHABILITY: "+str(Cost)+"%")
